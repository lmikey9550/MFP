...
"table.providerModelCapabilities": "能力",
    ...
    "fields.apiPort": "代理监听端口", "fields.adminPort": "管理台监听端口", "fields.trustAuth": "透传 Authorization", "rule.action.failover": "故障转移", "rule.action.retry": "重试", "rule.action.reject": "拒绝", "rule.impact.none": "无", "rule.impact.model": "后端模型", "rule.impact.provider": "Provider", "rule.impact.credential": "凭据",
    ...
    "table.provider": "提供方", "table.model": "模型", "table.priority": "优先级", "table.retry": "重试", "table.capabilities": "能力", "table.enabled": "启用", "table.modelId": "模型 ID", "table.label": "标签", "table.id": "ID", "table.name": "备注", "table.action": "动作", "table.impact": "影响范围", "table.cooldown": "冷却", "table.category": "错误类型", "table.statusCode": "状态码", "table.bodyContains": "正文包含", "table.username": "用户名", "table.role": "角色", "table.newPassword": "新密码", "table.time": "时间", "table.virtual": "前端模型", "table.actual": "后端模型", "table.status": "状态", "table.reason": "原因", "table.failover": "故障转移", "table.attempts": "尝试链路", "table.failures": "失败次数", "table.avgMs": "平均耗时", "table.scope": "作用域", "table.expires": "过期时间",
  ...
  "en-US": {
    ...
    "fields.apiPort": "API listen port", "fields.adminPort": "Admin listen port", "fields.trustAuth": "Forward Authorization", "rule.action.failover": "Failover", "rule.action.retry": "Retry", "rule.action.reject": "Reject", "rule.impact.none": "None", "rule.impact.model": "Backend model", "rule.impact.provider": "Provider", "rule.impact.credential": "Credential",
